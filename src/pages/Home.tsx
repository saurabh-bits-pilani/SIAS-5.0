...
import { Star, Calendar, Users, Heart, ArrowRight, Play } from 'lucide-react';
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    script.src = 'https://app.reviewconnect.me/embed/sUdwlFQNSfZS6jrNWLD4rsf9ArYJV3ZB/widget.js';
    script.async = true;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            ...
            >
              ...
              <h4 className="font-heading font-bold text-lg text-white mb-3">Authentic Vedic Wisdom</h4>
            ...
            >
              ...
              <h4 className="font-heading font-bold text-lg text-white mb-3">Compassionate Guidance</h4>
            ...
            >
              ...
              <h4 className="font-heading font-bold text-lg text-white mb-3">Personalized Approach</h4>
            ...
            >
              ...
              <h4 className="font-heading font-bold text-lg text-white mb-3">Proven Transformation</h4>
