...
import { ArrowLeft, Clock, Star, Users, CheckCircle, ArrowRight, Phone, MessageCircle } from 'lucide-react';
...
const ServiceDetail = () => {
  ...
  const currentService = serviceDetails[category as string]?.[service as string];
  ...
  return (
    <>
      <SEOHead
        title={`${currentService.title} - ${categoryNames[category as string]} | Soul Infinity`}
      ...
      <section className="bg-surface py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-primary-600 font-medium">{currentService.title}</span>
          </nav>
        </div>
      </section>
