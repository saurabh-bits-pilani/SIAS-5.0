                    ...
                    <div className="p-6">
                      ...
                      <div className="mb-4">
                        ...
                        <ul className="text-sm text-gray-600 space-y-1">
                          {remedy.symptoms.slice(0, 2).map((symptom, idx) => (
                            <li key={idx} className="line-clamp-1">• {symptom}</li>
                          ))}
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="text-sm text-gray-600 space-y-1">
                          {remedy.remedies.slice(0, 2).map((solution, idx) => (
                            <li key={idx} className="line-clamp-1">• {solution}</li>
                          ))}
                      ...
                      {/* View Details Button */}
                      <button className="w-full bg-gradient-to-r from-primary-50 to-secondary-50 text-primary-700 px-4 py-3 rounded-lg font-semibold hover:from-primary-100 hover:to-secondary-100 transition-all duration-300 transform group-hover:scale-105 border border-primary-200">
                        View Full Details
                      </button>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <ul className="space-y-3">
                      {selectedRemedy.symptoms.map((symptom: string, index: number) => (
                  ...
                  <div>
                    ...
                    <ul className="space-y-3">
                      {selectedRemedy.remedies.map((remedy: string, index: number) => (
                        <li key={index} className="flex items-start space-x-3">
