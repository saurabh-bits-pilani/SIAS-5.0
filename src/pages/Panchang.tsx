...
const Panchang = () => {
  ...
  // Mock Panchang data - in a real app, this would come from an API
  const generatePanchang = (date: Date) => {
    const tithis = [
  ...
  useEffect(() => {
    setPanchang(generatePanchang(selectedDate));
  }, [selectedDate]);
  ...
  if (!panchang) return <div>Loading...</div>;
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            >
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-300 to-secondary-300">Daily</span> Panchang
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
