...
import { Play, Pause, Clock, Calendar, Download, Share2, Mic } from 'lucide-react';
...
const CosmicPodcast = () => {
  ...
  const categories = ['All', 'Vedic Astrology', 'Spiritual Wisdom', 'Energy Healing', 'Astrology Methods', 'Crystal Therapy', 'Spiritual Practice'];
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                <div className="relative h-64 lg:h-auto">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <button
                      ...
                      className="w-20 h-20 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white transition-all duration-300 transform hover:scale-110 shadow-lg"
                    >
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <div className="flex items-center space-x-4">
                    <button
                      onClick={() => togglePlay(featuredEpisode.id)}
                      className="bg-primary-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-800 transition-colors inline-flex items-center"
                    >
                      {playingEpisode === featuredEpisode.id ? (
                        <>
              ...
              >
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300 bg-black/20">
                    <button
                      ...
                      className="w-16 h-16 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white transition-all duration-300 transform hover:scale-110 shadow-lg"
                    >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      onClick={() => togglePlay(episode.id)}
                      className="flex-1 bg-primary-500 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary-800 transition-colors inline-flex items-center justify-center"
                    >
                      {playingEpisode === episode.id ? (
                        <>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-secondary-600 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto mb-8">
            <a
              href="#"
              className="bg-white/20 backdrop-blur-sm text-white px-6 py-3 rounded-lg font-semibold hover:bg-white/30 transition-all duration-300 inline-flex items-center justify-center"
            >
              Apple Podcasts
            </a>
            <a
          ...
          <a
            href="https://wa.me/919079053840?text=Hi, I'd like to know more about the Cosmic Podcast"
            target="_blank"
